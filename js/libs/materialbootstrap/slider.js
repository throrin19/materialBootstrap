...
(function ($){
    ...
    function Slider() {
        ...
        this.valueToPosition = function valueToPosition(value) {
        ...
        this.resizeSlider = function resizeSlider() {
    ...
    function Range() {
        ...
        this.valuesToPosition = function valuesToPosition(values) {
            var min     = this.opts.min > 0 ? this.opts.min : this.opts.max,
        ...
        this.roundValues = function roundValues(value1, value2, opts) {
